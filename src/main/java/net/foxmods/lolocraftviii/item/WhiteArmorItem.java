...
public class WhiteArmorItem extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:white_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("lolocraft:white_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("lolocraft:white_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("lolocraft:white_armor_boots")
	public static final Item boots = null;

	public WhiteArmorItem(LolocraftModElements instance) {
		super(instance, 9);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(LoloCraftV3ItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "lolocraft:textures/models/armor/white_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
