...
public class WhiteIngotItem extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:white_ingot")
	public static final Item block = null;

	public WhiteIngotItem(LolocraftModElements instance) {
		super(instance, 7);
	}
