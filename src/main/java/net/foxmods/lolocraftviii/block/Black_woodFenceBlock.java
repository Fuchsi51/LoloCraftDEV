...
public class Black_woodFenceBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_wood_fence")
	public static final Block block = null;

	public Black_woodFenceBlock(LolocraftModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_wood_fence");
		}
