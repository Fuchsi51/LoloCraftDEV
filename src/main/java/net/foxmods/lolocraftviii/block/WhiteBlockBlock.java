...
public class WhiteBlockBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:white_block")
	public static final Block block = null;

	public WhiteBlockBlock(LolocraftModElements instance) {
		super(instance, 8);
	}
