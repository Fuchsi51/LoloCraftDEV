...
public class Black_woodWoodBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_wood_wood")
	public static final Block block = null;

	public Black_woodWoodBlock(LolocraftModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("black_wood_wood");
		}
