...
public class Black_woodSlabBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_wood_slab")
	public static final Block block = null;

	public Black_woodSlabBlock(LolocraftModElements instance) {
		super(instance, 50);
	}
