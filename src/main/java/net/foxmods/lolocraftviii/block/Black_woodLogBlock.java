...
public class Black_woodLogBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_wood_log")
	public static final Block block = null;

	public Black_woodLogBlock(LolocraftModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("black_wood_log");
		}
