...
public class Black_woodLeavesBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_wood_leaves")
	public static final Block block = null;

	public Black_woodLeavesBlock(LolocraftModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("black_wood_leaves");
		}
