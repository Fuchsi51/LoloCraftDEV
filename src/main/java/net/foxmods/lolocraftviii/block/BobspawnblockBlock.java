...
import net.foxmods.lolocraftviii.procedures.BobspawnblockWennDerSpielerZuZerstorenBeginntProcedure;
import net.foxmods.lolocraftviii.procedures.BobspawnblockWennDerBlockVomSpielerZerstortWirdProcedure;
...
public class BobspawnblockBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:bobspawnblock")
	public static final Block block = null;

	public BobspawnblockBlock(LolocraftModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			BobspawnblockWennDerBlockVomSpielerZerstortWirdProcedure.executeProcedure(Stream
		...
		public void onBlockClicked(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity) {
			...
			BobspawnblockWennDerSpielerZuZerstorenBeginntProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
