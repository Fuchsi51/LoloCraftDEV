...
public class Black_woodPressurePlateBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_wood_pressure_plate")
	public static final Block block = null;

	public Black_woodPressurePlateBlock(LolocraftModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("black_wood_pressure_plate");
		}
