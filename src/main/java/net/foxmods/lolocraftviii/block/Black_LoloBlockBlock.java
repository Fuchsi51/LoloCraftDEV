...
public class Black_LoloBlockBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_lolo_block")
	public static final Block block = null;

	public Black_LoloBlockBlock(LolocraftModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_lolo_block");
		}
