...
import net.foxmods.lolocraftviii.item.Black_LoloIngotItem;
...
public class Black_LoloOreBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_lolo_ore")
	public static final Block block = null;

	public Black_LoloOreBlock(LolocraftModElements instance) {
		super(instance, 40);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_lolo_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Black_LoloIngotItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lolocraft:black_lolo_ore_match"), () -> CustomRuleTest.codec);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("lolocraft:blacklolobiom").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
