...
public class Black_woodButtonBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_wood_button")
	public static final Block block = null;

	public Black_woodButtonBlock(LolocraftModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("black_wood_button");
		}
