...
public class Black_woodStairsBlock extends LolocraftModElements.ModElement {
	@ObjectHolder("lolocraft:black_wood_stairs")
	public static final Block block = null;

	public Black_woodStairsBlock(LolocraftModElements instance) {
		super(instance, 49);
	}
