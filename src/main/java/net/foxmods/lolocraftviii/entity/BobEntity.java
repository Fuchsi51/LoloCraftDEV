...
package net.foxmods.lolocraftviii.entity;
...
import net.foxmods.lolocraftviii.procedures.BobWennEntitatScheitertProcedure;
import net.foxmods.lolocraftviii.item.BobweaponItem;
import net.foxmods.lolocraftviii.entity.renderer.BobRenderer;
...
public class BobEntity extends LolocraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.95f)).build("bob").setRegistryName("bob");

	public BobEntity(LolocraftModElements instance) {
		super(instance, 31);
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, BobEntity.CustomEntity.class, true, false));
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, BobEntity.CustomEntity.class, true, true));
		...
		public void onDeath(DamageSource source) {
			...
			BobWennEntitatScheitertProcedure.executeProcedure(Stream
